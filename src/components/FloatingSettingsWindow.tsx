...
export function FloatingSettingsWindow({ isOpen, onClose }: FloatingSettingsWindowProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] pointer-events-none">
      <div
        ref={windowRef}
        className="absolute pointer-events-auto bg-background border border-border rounded-lg shadow-2xl"
        style={{
          left: position.x,
          top: position.y,
      ...
      >
        {/* 标题栏 */}
        <div 
          className="flex items-center justify-between p-3 cursor-move bg-muted/30 border-b border-border rounded-t-lg"
        ...
        {!isMinimized && (
          <div className="flex flex-col h-[calc(100%-60px)]">
            ...
            {/* 底部按钮栏 */}
            <div className="flex justify-between items-center p-3 border-t border-border bg-muted/20 rounded-b-lg">
